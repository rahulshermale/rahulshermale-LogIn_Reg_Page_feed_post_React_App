...
const View_AllPost = (props) => {
  ...
  return (
    <div className=" p-3 mb-2 bg-primary-subtle text-primary-emphasis">
      <br />
      <br />
      <h2 className=" mb-2 bg-primary-dark text-center ">ALL User Post </h2>
      <br />
      <br />
      <div className="row">
        {mydata.map((emp) => (
          <div key={emp.id} className="col-md-6">
            <div className="card border-secondary mb-4">
              ...
              <div className="card-body">
                <h5 className="card-text text-center text-dark text-lg">
                  {emp.post}
                </h5>{" "}
                <br />
                ...
                <br />
                <p className="card-text text-center">Created : {emp.name}</p>
